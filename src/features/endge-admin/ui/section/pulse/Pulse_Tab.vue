...
import { pulseActiveTab, pulseSelectedHost, startPulseRuntimeSync, stopPulseRuntimeSync } from '@/features/endge-admin/model/pulse/pulse.mock.ts'
import PulseDetailsPanel from '@/features/endge-admin/ui/section/pulse/PulseDetailsPanel.vue'
import PulseDiagnosticsPanel from '@/features/endge-admin/ui/section/pulse/PulseDiagnosticsPanel.vue'
import PulseOverviewPanel from '@/features/endge-admin/ui/section/pulse/PulseOverviewPanel.vue'

function moveToWidget(): void {
  EndgeAdmin.tabs.closeTab('pulse')
  showWidget('pulse')
}
