...
const tableRt = computed(() => EndgeAdmin.demonstration.tableRt.value)
const tableBasePath = computed(() => EndgeAdmin.demonstration.tableBasePath.value)
const helpData = computed(() => EndgeAdmin.demonstration.helpData.value)
