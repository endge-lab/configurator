...
import type { RActionEditor } from '@/features/endge-admin/domain/entities/RActionEditor'
...
import { getEndgeFlowPaletteGroupByKind, groupEndgeFlowPalette, shouldShowEndgeFlowPaletteKind } from '@/features/endge-admin/model/action-flow-editor/endge-flow-palette'
import DomainEntityDropTarget from '@/features/endge-admin/ui/components/DomainEntityDropTarget.vue'
import EndgeFlowBottomPanel from '@/features/endge-admin/ui/section/action/flow-editor/EndgeFlowBottomPanel.vue'
import EndgeFlowContextTree from '@/features/endge-admin/ui/section/action/flow-editor/EndgeFlowContextTree.vue'
import EndgeFlowPalette from '@/features/endge-admin/ui/section/action/flow-editor/EndgeFlowPalette.vue'
import EndgeFlowPayloadDialog from '@/features/endge-admin/ui/section/action/flow-editor/EndgeFlowPayloadDialog.vue'
...
const flowBlockSpecs = computed<EndgeAdminFlowBlockSpec[]>(() => EndgeAdmin.flowCatalog.listBlockSpecs())
...
const selectedInputAcceptSectionTypes = computed<DomainSectionType[]>(() => {
  ...
  const mapping: Record<string, DomainSectionType> = {
    ...
    'scenario': DomainSectionType.Scenario,
    'settings': DomainSectionType.Settings,
    'setting': DomainSectionType.Settings,
...
const selectedInputReferenceOptions = computed(() => {
  ...
  const sourceMap: Record<string, Array<Record<string, unknown>> | undefined> = {
    ...
    'scenario': domainStore.scenarios as Array<Record<string, unknown>> | undefined,
    'scenarios': domainStore.scenarios as Array<Record<string, unknown>> | undefined,
    'setting': domainStore.settings as Array<Record<string, unknown>> | undefined,
    'settings': domainStore.settings as Array<Record<string, unknown>> | undefined,
...
function getReferenceHintText(): string {
  ...
  const labels: Record<string, string> = {
    ...
    [DomainSectionType.Settings]: 'настройки',
