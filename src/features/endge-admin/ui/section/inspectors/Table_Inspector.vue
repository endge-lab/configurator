...
import {
  ...
  autoFillColumn,
  buildAccessor,
} from "@/features/endge-admin/tools/table-editor-helper";
...
function restoreFromLocalStorage(): void {
  ...
  try {
    ...
    EndgeAdmin.demonstration.setHelpData({
...
async function executeQuery(): Promise<void> {
  ...
  activeTabKey.value = "";
  try {
    const help = await EndgeAdmin.demonstration.runQueryAndSetHelpData(id);
    if (help) {
