...
import type { RComponentTableColumnEditor } from "@/features/endge-admin/domain/entities/RComponentTableColumnEditor";
...
import { registerAgentTableAction } from "@/features/endge-admin/model/agent/agent-table-actions";
...
function openDemonstration(): void {
  ...
  if (!id) return;
  EndgeAdmin.demonstration.showTable(id);
}
          ...
          <Tooltip>
            <TooltipTrigger as-child>
              <Button
                ...
                :disabled="EndgeAdmin.busy.value"
                @click="save"
              >
                <Loader2
                  v-if="EndgeAdmin.busy.value"
