...
import type { NavigationTreeNodeEditor, NavigationTreeNodeType, RNavigationEditor } from '@/features/endge-admin/domain/entities/RNavigationEditor'
...
import NavigationEditorTreeNode from '@/features/endge-admin/ui/components/NavigationEditorTreeNode.vue'
