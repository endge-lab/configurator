...
import { duplicateEntity } from '@/features/endge-admin/model/domain/domain-duplicate'
...
async function onSubmit(): Promise<void> {
  ...
  try {
    ...
    EndgeAdmin.tabs.openDocument(newIdentity, props.source.docType as DomainDocumentType)
