...
import { endgeAdminWidgetsConfig } from '@/features/endge-admin/config/widgets.ts'
 ...
 */
export class EndgeAdminWidgets {
  private _widgetDefinitions = endgeAdminWidgetsConfig
