 ...
 */
export class EndgeAdminConsole {
  /**
   * LIFECYCLE
   */
  public init(): void {
    Endge.console.register('tab', () => this.tab(), 'Текущая вкладка админки')
  ...
  public tab(): void | Promise<void> {
    console.log(EndgeAdmin.tabs.activeTab.value)
  }
  ...
  public document(): void | Promise<void> {
    ...
    console.log(EndgeAdmin.tabs.documentModel)
    console.log('[EditorModel]')
    console.log(EndgeAdmin.tabs.documentEditorModel.value)
  }
