...
export class EndgeAdminDocs {
  ...
  public init(): void {
    this._entries = [
      ...
      { id: 'submodules-endge-vue', title: 'Federation EndgeVue', description: 'Интеграционный слой @endge/vue: регистрации render-компонентов и фаз Raph.', icon: 'ti ti-brand-vue', file: 'submodules/EndgeVue', category: DocsCategory.EndgeSubModules },
      { id: 'submodules-app-core', title: 'Federation AppCore', description: 'Прикладная федерация: orchestration bootstrap, Endge.init и запуск бизнес-модулей.', icon: 'ti ti-layers-linked', file: 'submodules/AppCore', category: DocsCategory.EndgeSubModules },
      { id: 'submodules-app-core-domain', title: 'AppCore.domain', description: 'Единственный модуль федерации AppCore: AppDomain.', icon: 'ti ti-database', file: 'submodules/AppCoreDomain', category: DocsCategory.EndgeSubModules },
      { id: 'submodules-app-core-bootstrap', title: 'AppCore bootstrap', description: 'Pipeline инициализации конфигуратора с зависимостями.', icon: 'ti ti-route-2', file: 'submodules/AppCoreBootstrap', category: DocsCategory.EndgeSubModules },
      { id: 'submodules-app-core-integration', title: 'AppCore integrations', description: 'Связка Endge.init + EndgeVue.init + Endge.runtime.init.', icon: 'ti ti-link', file: 'submodules/AppCoreIntegration', category: DocsCategory.EndgeSubModules },
      { id: 'submodules-app', title: 'Endge.app', description: 'Метаданные текущего приложения/проекта и проектный контекст.', icon: 'ti ti-app-window', file: 'submodules/App', category: DocsCategory.EndgeCoreModules },
      { id: 'submodules-bootstrap', title: 'Endge.bootstrap', description: 'Пошаговый запуск приложения с зависимостями.', icon: 'ti ti-player-play', file: 'submodules/Bootstrap', category: DocsCategory.EndgeCoreModules },
