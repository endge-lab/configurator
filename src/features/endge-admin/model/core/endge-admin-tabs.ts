...
import { RIntegrationEditor } from '@/features/endge-admin/domain/entities/RIntegrationEditor.ts'
import { REnvironmentEditor } from '@/features/endge-admin/domain/entities/REnvironmentEditor.ts'
import { RTenantEditor } from '@/features/endge-admin/domain/entities/RTenantEditor.ts'
import { RPolicyEditor } from '@/features/endge-admin/domain/entities/RPolicyEditor.ts'
import { RStyleEditor } from '@/features/endge-admin/domain/entities/RStyleEditor.ts'
import { RVocabsEditor } from '@/features/endge-admin/domain/entities/RVocabsEditor.ts'
import { RI18nBundleEditor } from '@/features/endge-admin/domain/entities/RI18nBundleEditor.ts'
import { RPageTemplateEditor } from '@/features/endge-admin/domain/entities/RPageTemplateEditor.ts'
import { RPageEditor } from '@/features/endge-admin/domain/entities/RPageEditor.ts'
import { RNavigationEditor } from '@/features/endge-admin/domain/entities/RNavigationEditor.ts'
import { RProjectEditor } from '@/features/endge-admin/domain/entities/RProjectEditor.ts'
import { RViewEditor } from '@/features/endge-admin/domain/entities/RViewEditor.ts'
import { RFilterEditor } from '@/features/endge-admin/domain/entities/RFilterEditor.ts'
import { RParameterEditor } from '@/features/endge-admin/domain/entities/RParameterEditor.ts'
import { RQueryEditor } from '@/features/endge-admin/domain/entities/RQueryEditor.ts'
import { RSettings_Editor } from '@/features/endge-admin/domain/entities/RSettings_Editor.ts'
import { RScenarioEditor } from '@/features/endge-admin/domain/entities/RScenarioEditor.ts'
import { RTypeEditor } from '@/features/endge-admin/domain/entities/RTypeEditor.ts'
import { endgeAdminTabsConfig } from '@/features/endge-admin/config/tabs.ts'
import { DOCS_VIEW_ID } from '@/features/endge-admin/model/core/endge-admin-docs.ts'
import { getBehaviorBindingEditorState } from '@/features/endge-admin/model/bindings/behavior-binding-editor-state.ts'
import { getPresentationBindingEditorState } from '@/features/endge-admin/model/bindings/presentation-binding-editor-state.ts'
...
import QueryCustom_Editor from '@/features/endge-admin/ui/section/document/entity/QueryCustom_Editor.vue'
import QueryGraphQL_Editor from '@/features/endge-admin/ui/section/document/entity/QueryGraphQL_Editor.vue'
import QueryRest_Editor from '@/features/endge-admin/ui/section/document/entity/QueryRest_Editor.vue'
import Scenario_Editor from '@/features/endge-admin/ui/section/document/entity/Scenario_Editor.vue'
import Type_Editor from '@/features/endge-admin/ui/section/document/entity/Type_Editor.vue'
import Converter_Editor from '@/features/endge-admin/ui/section/document/entity/Converter_Editor.vue'
import Integration_Editor from '@/features/endge-admin/ui/section/document/entity/Integration_Editor.vue'
import Environment_Editor from '@/features/endge-admin/ui/section/document/entity/Environment_Editor.vue'
import Tenant_Editor from '@/features/endge-admin/ui/section/document/entity/Tenant_Editor.vue'
import Policy_Editor from '@/features/endge-admin/ui/section/document/entity/Policy_Editor.vue'
import Style_Editor from '@/features/endge-admin/ui/section/document/entity/Style_Editor.vue'
import Vocabs_Editor from '@/features/endge-admin/ui/section/document/entity/Vocabs_Editor.vue'
import I18nBundles_Editor from '@/features/endge-admin/ui/section/document/entity/I18nBundles_Editor.vue'
import View_Editor from '@/features/endge-admin/ui/section/document/entity/View_Editor.vue'
import PageTemplate_Editor from '@/features/endge-admin/ui/section/document/entity/PageTemplate_Editor.vue'
import Page_Editor from '@/features/endge-admin/ui/section/document/entity/Page_Editor.vue'
import Navigation_Editor from '@/features/endge-admin/ui/section/document/entity/Navigation_Editor.vue'
import Project_Editor from '@/features/endge-admin/ui/section/document/entity/Project_Editor.vue'
import Filter_Editor from '@/features/endge-admin/ui/section/document/entity/Filter_Editor.vue'
import Settings_Editor from '@/features/endge-admin/ui/section/document/singleton/Settings_Editor.vue'
import Version_Editor from '@/features/endge-admin/ui/section/document/singleton/Version_Editor.vue'
import ViewGenerator_Editor from '@/features/endge-admin/ui/section/document/singleton/ViewGenerator_Editor.vue'
import NovaSandbox_Singleton from '@/features/endge-admin/ui/section/document/singleton/NovaSandbox_Singleton.vue'
import ActionPlaygrounds_Singleton from '@/features/endge-admin/ui/section/document/singleton/ActionPlaygrounds_Singleton.vue'
...
export class EndgeAdminTabs {
  ...
  public constructor() {
    this._tabsApi = useSmartTabs({
      ...endgeAdminTabsConfig,
      persist: !isAdminTabStorageDisabled(),
    })
  }
  ...
  private async _doSave(activeTab: SmartTabRef): Promise<void> {
    ...
    try {
      ...
      console.error('[EndgeAdminTabs] save', e)
