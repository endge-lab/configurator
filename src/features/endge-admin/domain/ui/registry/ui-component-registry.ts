import type { UIAstNodeBase, UIAstNodeLayout, UIPrimitiveKind } from '@/features/endge-admin/domain/ui/ast/UIAstNode'
...
import {
  ...
  uiTableDefinition,
  uiTextDefinition,
} from '@/features/endge-admin/domain/ui/definitions/builtin'
