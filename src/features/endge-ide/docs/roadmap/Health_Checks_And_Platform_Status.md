...
- Выделить модуль/сервис «platform health» (или расширить конфигурацию/диагностику): функция `checkHealth()` → Promise<HealthStatus>; приложение вызывает её при старте и при необходимости по таймеру.
