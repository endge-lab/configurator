...
- **Nova (графика)**: канвас по умолчанию недоступен для скринридера; давать текстовое описание сцены или ключевых элементов (aria-label, скрытый текст) и по возможности дублировать критичные действия кнопками/ссылками с текстом.
...
- Nova и тяжёлая графика: текстовые альтернативы, описание сцены; критичные действия — дублирование доступными контролами.
