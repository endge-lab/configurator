...
import type { SmartTabsApi } from '@/features/endge-ide/ui/smart-tabs/types'

import { provide } from 'vue'

import { SMART_TAB_VIEW_STATE_SCOPE } from '@/features/endge-ide/ui/smart-tabs/useSmartTabViewState'
...
provide(SMART_TAB_VIEW_STATE_SCOPE, {
  ...
  readVolatile: key => props.api.getTabVolatileViewState(props.tabId, key),
  writeVolatile: (key, slice) => props.api.setTabVolatileViewState(props.tabId, key, slice),
  clearVolatile: key => props.api.clearTabVolatileViewState(props.tabId, key),
