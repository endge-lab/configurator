...
/** Выполнить запрос из домена (в т.ч. с customExecutor), результат в консоль + toast */
async function runQuery(): Promise<void> {
  ...
  try {
    ...
    console.log('[InspectorRest] Результат запроса:', result)
    toast.success('Запрос выполнен', { description: 'Результат выведен в консоль' })
  } catch (e: any) {
    console.error('[InspectorRest] Ошибка выполнения запроса:', e)
