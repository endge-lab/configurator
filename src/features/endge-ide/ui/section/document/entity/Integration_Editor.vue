    ...
    <div class="p-3 border-b flex items-center gap-3 shrink-0">
      ...
      <div class="min-w-0 flex-1">
        <div class="text-lg font-semibold truncate">
          {{ $t('uiText.integrationD25926dd') }} {{ editor?.displayName ?? '-' }}
        </div>
      ...
      <div class="p-4 space-y-4">
        ...
        <div class="space-y-2">
          ...
          <textarea
            ...
            class="flex min-h-[80px] w-full rounded-md border border-input bg-editor-control px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
