...
import { getEventContractsForDocument } from '@/features/endge-ide/model/bindings/use-event-contracts'
import { setBehaviorBindingEditorState } from '@/features/endge-ide/model/bindings/behavior-binding-editor-state'
