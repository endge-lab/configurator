...
import { ConfiguratorWidgetRegistry } from '@/features/endge-ide/model/modules/integrations/ConfiguratorWidgetRegistry'
...
/** Owns configurator-only integration entrypoints for the active IDE surface. */
