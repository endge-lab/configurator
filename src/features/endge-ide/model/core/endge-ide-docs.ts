  ...
  public init(): void {
    this._entries = [
      ...
      },
      {
        id: 'how-to-use-views',
        title: 'Виды',
        description: 'Persisted-связи вида; legacy component reference больше не запускается.',
        icon: 'ti ti-eye',
      ...
      { id: 'submodules-bindings', title: 'Endge.configuration.behaviorBindings', description: 'Declarative behavior bindings: resolver, dispatch и запуск actions.', icon: 'ti ti-link', file: 'submodules/Bindings', category: DocsCategory.EndgeCoreModules },
