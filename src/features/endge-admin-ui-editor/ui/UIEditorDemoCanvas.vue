...
import { UI_EDITOR_DND_MIME } from '@/features/endge-admin-ui-editor/entities/ui-editor-demo-state'
...
<template>
  ...
  >
    <div class="min-h-0 flex-1 overflow-auto">
      ...
      >
        <div
          class="mx-auto h-fit min-h-full w-full shadow-[0_16px_40px_rgba(15,23,42,0.08)] transition dark:shadow-[0_18px_48px_rgba(0,0,0,0.34)]"
