...
import type { WidgetDefinition, WidgetDefinitionState, WidgetInstance, WidgetPosition } from '@/app/ui/layouts/grid/types.ts'

import { computed } from 'vue'
import { useI18n } from 'vue-i18n'

import { getIconComponent } from '@/app/ui/layouts/grid/icons.ts'
import { endWidgetDrag, getLayoutState, getPopupInstances, getWidgetInstances, getWidgetOrder, moveWidget, reorderWidget, restorePopupInstance, startWidgetDrag, toggleWidget } from '@/app/ui/layouts/grid/layout.ts'
