...
import type { WidgetPosition } from '@/app/ui/layouts/grid/types.ts'
import { computed } from 'vue'
import { getLayoutState, getWidgetInstances, getWidgetsByPosition } from '@/app/ui/layouts/grid/layout.ts'
import WidgetContainer from '@/app/ui/layouts/grid/WidgetContainer.vue'
