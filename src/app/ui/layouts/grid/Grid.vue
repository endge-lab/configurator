...
import FloatingWidgets from '@/app/ui/layouts/grid/FloatingWidgets.vue'
import GridHeader from '@/app/ui/layouts/grid/GridHeader.vue'
import { cleanupWidgetChannel, closeNonDetachablePopups, endWidgetDrag, getAreaSize, getLayoutState, getWidgetsByPosition, initWidgetChannel, moveWidget, setAreaSize, setLayoutScope } from '@/app/ui/layouts/grid/layout.ts'
import WidgetArea from '@/app/ui/layouts/grid/WidgetArea.vue'
import WidgetPanel from '@/app/ui/layouts/grid/WidgetPanel.vue'
