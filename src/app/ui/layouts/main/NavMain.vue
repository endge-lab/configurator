...
import type { NavItemGroup } from '@/app/ui/layouts/main/navigation.ts'
...
import { isGroupActiveByRoute, isItemGroup, isItemLink, useNavigation } from '@/app/ui/layouts/main/navigation.ts'
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
