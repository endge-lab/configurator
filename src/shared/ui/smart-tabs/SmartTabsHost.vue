...
import type { SmartTabRef, SmartTabsApi, SmartTabsOptions } from '@/shared/ui/smart-tabs/types'

import { CircleX, CopyX, PanelLeftClose, PanelRightClose, X } from 'lucide-vue-next'
import { computed, defineAsyncComponent, h, ref, watch } from 'vue'

import SmartTabViewStateScope from '@/shared/ui/smart-tabs/SmartTabViewStateScope.vue'
