...
export default defineConfig({
  ...
  webServer: [
    { command: 'pnpm exec vite --config e2e/vite.config.ts --host 127.0.0.1 --port 4173 --strictPort', url: 'http://127.0.0.1:4173/e2e/fixture.html', reuseExistingServer: false, timeout: 300_000 },
