...
> {
  ...
  onCustom<K extends keyof CustomEventMap>(
    events: OneOrMany<K>,
    callback: EventCallback<CustomEventMap[K]>,
  ): void {
    this._on(events as string | string[], callback)
  }

  onceCustom<K extends keyof CustomEventMap>(
    events: OneOrMany<K>,
    callback: EventCallback<CustomEventMap[K]>,
  ): void {
    this._once(events as string | string[], callback)
  ...
  offCustom<K extends keyof CustomEventMap>(
    events: OneOrMany<K>,
    callback: EventCallback<CustomEventMap[K]>,
  ): void {
    this._off(events as string | string[], callback)
  ...
  emitCustom<K extends keyof CustomEventMap>(
    event: K,
